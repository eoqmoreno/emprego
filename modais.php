                    ...
                    <form action="./login.php" method="post">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="submit" value="Cadastrar" data-dismiss="modal" aria-label="Close" class="btn bg-azulClaro branco text-center f-text-80 pb-0" data-toggle="modal" data-target="#cadCurriculo">
                            </div>
                        </div>
                </div>
            </div>
